...
public class ClickGui
    ...
    public Setting<Integer> red = this.register(new Setting<Integer>("Red", 182, 0, 255));
    public Setting<Integer> green = this.register(new Setting<Integer>("Green", 139, 0, 255));
    public Setting<Integer> blue = this.register(new Setting<Integer>("Blue", 34, 0, 255));
    ...
    public Setting<Integer> topAlpha = this.register(new Setting<Object>("TopAlpha", Integer.valueOf(111), Integer.valueOf(0), Integer.valueOf(255), v -> this.devSettings.getValue()));
