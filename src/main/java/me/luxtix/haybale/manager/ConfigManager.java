...
import me.luxtix.haybale.features.modules.render.XRay;
import me.luxtix.haybale.features.setting.Bind;
import me.luxtix.haybale.features.setting.EnumConverter;
...
public class ConfigManager
    ...
    public String config = "haybale/config/";
    ...
    public void loadConfig(String name) {
        ...
        final List<File> files = Arrays.stream(Objects.requireNonNull(new File("haybale").listFiles())).filter(File::isDirectory).collect(Collectors.toList());
        this.config = files.contains(new File("haybale/" + name + "/")) ? "haybale/" + name + "/" : "haybale/config/";
    ...
    public void saveCurrentConfig() {
        File currentConfig = new File("haybale/currentconfig.txt");
        try {
            if (currentConfig.exists()) {
                FileWriter writer = new FileWriter(currentConfig);
                String tempConfig = this.config.replaceAll("/", "");
                writer.write(tempConfig.replaceAll("haybale", ""));
                writer.close();
            } else {
