...
implements Util {
    ...
    public static <BlockPos> void drawGradientFilledBoxVulcan(BlockPos renderPos, Color color, Color color1) {
    }

    public static void prepare(int i) {
    }

    public static <BlockPos> void drawBoundingBoxBottom2(BlockPos renderPos, float floatValue, int intValue, int intValue1, int intValue2, int intValue3) {
    }
