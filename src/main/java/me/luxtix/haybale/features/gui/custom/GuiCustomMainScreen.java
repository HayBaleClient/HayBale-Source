package me.luxtix.haybale.features.gui.custom;
...
public class GuiCustomMainScreen
        extends GuiScreen {
    private final String backgroundURL = "https://imgur.com/a/YUEgbHZ.png";
    ...
    public void initGui() {
        ...
        this.buttonList.add(new TextButton(0, this.x, this.y + 20, "LifelessMan"));
        this.buttonList.add(new TextButton(1, this.x, this.y + 44, "Friendly Boi"));
        this.buttonList.add(new TextButton(2, this.x, this.y + 66, "Settings"));
        this.buttonList.add(new TextButton(2, this.x, this.y + 88, "Go out"));
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        if (GuiCustomMainScreen.isHovered(this.x - Phobos.textManager.getStringWidth("LifelessMan") / 2, this.y + 20, Phobos.textManager.getStringWidth("Singleplayer"), Phobos.textManager.getFontHeight(), mouseX, mouseY)) {
            this.mc.displayGuiScreen(new GuiWorldSelection(this));
        } else if (GuiCustomMainScreen.isHovered(this.x - Phobos.textManager.getStringWidth("Friendly Boi") / 2, this.y + 44, Phobos.textManager.getStringWidth("Multiplayer"), Phobos.textManager.getFontHeight(), mouseX, mouseY)) {
        ...
        } else if (GuiCustomMainScreen.isHovered(this.x - Phobos.textManager.getStringWidth("Go out") / 2, this.y + 88, Phobos.textManager.getStringWidth("Exit"), Phobos.textManager.getFontHeight(), mouseX, mouseY)) {
            this.mc.shutdown();
        }
    }
