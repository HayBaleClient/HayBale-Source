...
public class OffhandRW
        extends Module {
    private static OffhandRW instance;
    ...
    public OffhandRW() {
        super("OffhandRw", "Allows you to switch up your Offhand.", Module.Category.COMBAT, true, false, false);
        instance = this;
    }

    public static OffhandRW getInstance() {
        if (instance == null) {
            instance = new OffhandRW();
        }
        return instance;
    }
