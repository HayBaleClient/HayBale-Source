...
import me.luxtix.haybale.event.events.RenderEntityModelEvent;
...
public class CrystalScale
    ...
    public Setting<Float> scale = this.register(new Setting<Float>("Scale", Float.valueOf(0.6f), Float.valueOf(0.1f), Float.valueOf(10.0f)));
    public Setting<Float> lineWidth = this.register(new Setting<Float>("LineWidth", Float.valueOf(1.1f), Float.valueOf(0.1f), Float.valueOf(3.0f)));
    ...
    public Setting<Integer> alpha = this.register(new Setting<Integer>("Alpha", 145, 0, 255));
