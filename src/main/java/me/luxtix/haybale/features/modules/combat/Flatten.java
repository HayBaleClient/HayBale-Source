...
public class Flatten extends Module
{
    ...
    public void onUpdate() {
        ...
        final int obbySlot = InventoryUtil2.findHotbarBlock((Class) BlockObsidian.class);
    ...
    private void place(final BlockPos pos, final int slot, final int oldSlot) {
        ...
        BlockUtil2.placeBlock(pos, EnumHand.MAIN_HAND, (boolean)this.rotate.getValue(), (boolean)this.packet.getValue(), Flatten.mc.player.isSneaking());
